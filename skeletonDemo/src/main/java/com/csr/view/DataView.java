        ...
        extends LinearLayout
{
    ...
    public DataView(Context context, AttributeSet attrs, int layoutResource)
    {
        ...
        if (layoutResource == USER_LAYOUT)
        {
            ...
            layoutResource = a.getResourceId(R.styleable.DataViewOptions_layout, R.layout.data_normal);
        }
        Drawable mIconDrawable = a.getDrawable(R.styleable.DataViewOptions_icon);
        a.recycle();
